...
public enum ErrorCode {
    ...
    INVALID_LOGIN_CREDENTIALS(HttpStatus.UNAUTHORIZED, "INVALID_LOGIN_CREDENTIALS", "이메일 또는 비밀번호가 올바르지 않습니다."), //REQ-026
    
    
    
	/////////// 403 - 인증은 됐지만 권한이 없는 경우 ///////////																// REQ
	FORBIDDEN(HttpStatus.FORBIDDEN, "FORBIDDEN", "접근 권한이 없습니다."),												// 019~023
    CHAT_ROOM_ACCESS_DENIED(HttpStatus.FORBIDDEN, "CHAT_ROOM_ACCESS_DENIED", "해당 채팅방에 접근할 권한이 없습니다."),			// C02
    NOT_FRIEND(HttpStatus.FORBIDDEN, "NOT_FRIEND", "친구가 아닌 사용자와는 채팅방을 생성할 수 없습니다."),						// C04
    
    
    

	/////////// 404 - 리소스를 찾을 수 없는 경우 ///////////																// REQ
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "E404_USER", "사용자를 찾을 수 없습니다."),										// 008, 014
    PRODUCT_NOT_FOUND(HttpStatus.NOT_FOUND, "E404_GIFT", "상품을 찾을 수 없습니다."),										// 007
    ORDER_NOT_FOUND(HttpStatus.NOT_FOUND, "ORDER_NOT_FOUND","선물 주문 정보를 찾을 수 없습니다."),							// 0XX
    GIFT_LINK_INVALID(HttpStatus.NOT_FOUND, "GIFT_LINK_INVALID","유효하지 않거나 만료된 선물 링크입니다."),					// 0XX
	...
	/////////// 409 - 현재 상태와 충돌하는 요청 ///////////																// REQ
    DUPLICATE_EMAIL(HttpStatus.CONFLICT, "DUPLICATE_EMAIL","이미 사용 중인 이메일입니다."),									// 016
    DUPLICATE_NICKNAME(HttpStatus.CONFLICT, "DUPLICATE_NICKNAME","이미 사용 중인 닉네임입니다."),							// +016
