    ...
    return (
        ...
        <DetailWrapper>
            ...
            <ProductInfoArea>
                ...
                <p className="product-price">{Number(product.price || 0).toLocaleString()}원</p>
            ...
            <ShareModal
                ...
                smsText={`[따숨품] ${product.name} ${Number(product.price || 0).toLocaleString()}원\n${shareUrl}`}
